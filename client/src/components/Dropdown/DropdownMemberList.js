...
const DropdownMemberList = ({ items, showDropdown }) => {
  return (
    <div className='dropdown-member-list'>
      <div className='dropdown-member-row'>
        <NavLink onClick={showDropdown} to='/favorites'>
      ...
      <div className='dropdown-member-row'>
        <NavLink onClick={showDropdown} to='/cart'>
          <div className='member-button-icon-wrapper'>
            <svg height='24px' width='24px' fill='#111' viewBox='0 0 24 24'>
      ...
      <div className='dropdown-member-row'>
        <NavLink onClick={showDropdown} to='/orders'>
          <div className='member-button-icon-wrapper'>
